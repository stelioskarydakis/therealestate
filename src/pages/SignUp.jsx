...
import { OAuth, Title } from "../components";
import {
  updateProfile,
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="relative mb-6">
              <input
                ...
                className="w-full px-4 py-2 text-sm text-gray-700 bg-white border-solid border border-black-100 shadow-2xl rounded transition ease-in-out"
              />
              {showPassword ? (
                <AiFillEyeInvisible
